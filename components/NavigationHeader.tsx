...
const NavigationHeader = () => {
  ...
  return (
    <>
        ...
        <div className="body-container flex space-x-4">
          ...
          <div className="w-1/2 md:w-2/3 flex items-center mx-auto">
            <div className="flex justify-end items-center w-full">
              ...
              <button
                className="bg-blue-600 cursor-pointer py-2 px-4 rounded-full ml-4 hidden md:flex items-center space-x-3 text-white"
                onClick={handleClick}
              >
                <span>Get Started</span>
                <span className="bg-white rounded-full p-1 flex items-center justify-center">
                  <ArrowRight className="w-4 h-4 text-[#145ae0]" />
                </span>
              </button>
            </div>
          </div>
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="absolute inset-x-2 z-10 bg-white p-4 rounded md:hidden text-black text-xl">
          ...
          <button
            className="bg-blue-600 cursor-pointer py-2 px-4 rounded w-full mt-4 flex items-center space-x-3 text-white"
            onClick={handleClick}
          >
            <span>Get Started</span>
            <span className="bg-white rounded-full p-1 flex items-center justify-center">
